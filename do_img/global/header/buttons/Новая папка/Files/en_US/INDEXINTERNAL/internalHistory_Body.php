...
<body onLoad="" >
    <?php
    $log->setId($Users->DataRow['ID'], $Users->DataRow['playerID']);
    $history = $log->getLog();
    ?>
<!-- affiliateStartTag -->
            ...
            <div id="infoLayerConfirm">
                ...
                <div class="popup_shop_abort_button">
                    <div class="popup_shop_abort_text"
                         style="background-image: url(
                            '../.?l=us&s=12&t=confirmBox_cancel&f=eurostyle_thea&color=white&bgcolor=grey'
                         );"
...
<div class="backgroundImageContainer">
    ...
    <div id="content">
        ...
        <div id="nav" style="text-align:right;">
            <img src="./do_img/global/teaser/left_start_01.jpg" width="157" height="439" border="0">
        </div>
        <!-- Ende Navigation -->
        <!-- Content -->
        <div id="mainContentAuktion" class="fliess11px-grey">
            <div id="inner-cont">
                                <div id="history" class="scrollbars">
                    <table border="0" width="440" cellpadding="0" cellspcaing="0" class="fliess11px-grey">
                    <tr>
                        <td style="125px"><img src="./do_img/global/s.gif?__cv=ad480fd0732d0f6f1a8b06359e3a4200" width="125" height="2"></td>
                        <td style="2px"><img src="./do_img/global/s.gif?__cv=ad480fd0732d0f6f1a8b06359e3a4200" width="2" height="2"></td>
                        <td style="313"><img src="./do_img/global/s.gif?__cv=ad480fd0732d0f6f1a8b06359e3a4200" width="313" height="2"></td>
                    </tr>
                    <tr>
                    ...
                    <?php foreach($history as $k => $v){
                      echo '<tr>
                        <td>'.$v['addDate'].'</td>
                        <td style="background-image:url(./do_img/global/payment/trenner.gif)"><img src="./do_img/global/s.gif" width="2" height="2"></td>
                        <td>'.$v['descrip'].'</td>
                    </tr>
                    <tr>
                        <td colspan="3"><img src="./do_img/global/payment/trennerw.gif" width="446" height="2"></td>
                    </tr>';  
                    }
                    ?>
                                        </table>
