...
function changeTeaser(show, hide) {
    $(show+'_teaser').style.backgroundImage = 'url(./do_img/global/left/button_active.png?__cv=62a003d4934cb9fc5b10c8ae17939b00)';
    $(show).style.display = "block";
    $(hide+'_teaser').style.backgroundImage = 'url(./do_img/global/left/button_normal.png?__cv=3eca2f61bbe1e73faebf277f57e1ff00)';
...
?>
  <div id="teaser_left" style="background-image: url(./do_img/global/teaser/left_start_<?php echo $randNum; ?>.jpg);">
                                        </div>
                </div>

        <!-- Ende Navigation -->
        <!-- Content -->
        <div id="mainContentStart" class="fliess11px-gelb" style="background-image: url(./do_img/en/bg_start.jpg?__cv=4a17f5b4999634b06a86f584e6f97900);">

            <div id="breakingNewsContainer" style="background-image: url(./do_img/global/events/benefitPremium.gif?__cv=9eb1a573d24ca0f231e9bbb5ec7c0400);">
            ...
            <div id="breakingNewsIconContainer">
                <div class="breakingNewsIcon" id="breakingNewsIcon1" onmouseover="breakingNews.over(1);" onmouseout="breakingNews.out();" onclick="showNews('benefitPremium');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/benefitPremium.gif?__cv=5992cf3238af515ea2c6d019a7707900);"></div>
                <div class="breakingNewsIcon" id="breakingNewsIcon2" onmouseover="breakingNews.over(2);" onmouseout="breakingNews.out();" onclick="showNews('messageSystemLaunch');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/messageSystemLaunch.gif?__cv=f1844f7361ac34b03cb1431fe2e8fe00);"></div>
                <div class="breakingNewsIcon" id="breakingNewsIcon3" onmouseover="breakingNews.over(3);" onmouseout="breakingNews.out();" onclick="showNews('achievementSystemMS2');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/achievementSystem.gif?__cv=e74351b6c2629f14313d1c053d981900);"></div>
                <div class="breakingNewsIcon" id="breakingNewsIcon4" onmouseover="breakingNews.over(4);" onmouseout="breakingNews.out();" onclick="showNews('killscreen2');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/killScreen.gif?__cv=057256af8dde4849f2c94af96014ff00);"></div>
                <div class="breakingNewsIcon" id="breakingNewsIcon5" onmouseover="breakingNews.over(5);" onmouseout="breakingNews.out();" onclick="showNews('hangarRenamingPremium');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/hangarRenaming.gif?__cv=110cb0962015ec01193ff603bb948700);"></div>
                <div class="breakingNewsIcon" id="breakingNewsIcon6" onmouseover="breakingNews.over(6);" onmouseout="breakingNews.out();" onclick="showNews('hadesGate');" style="margin-right: 8px; background-image: url(./do_img/global/events/icons/hadesGateAnnouncement.gif?__cv=537f89669a87ee8acfa0409c35ec7700);"></div>
            </div>
            <script type="text/javascript">
            ...
            <tr>
                ...
                <td id="cell_userInfo">
                    ...
                    <img src="./do_img/global/ranks/rank_<?php echo $rank['rank']; ?>.png" style="vertical-align: baseline; position: relative; top: 4px;"><?php echo $rank['name']; ?></div><br class="clearMe" />
                    ...
                    <div class="userInfo_left fliess10px-white">User since:</div><div class="userInfo_right"><?php echo $base->GetDateReg($Users->DataRow['ID']); ?></div><br class="clearMe" />                    <div class="userInfo_center">
