...
<div id="hof_content">
					...
					<table border="0" cellspacing="0" id="hof_faction_table" class="hof_ranking_table">
			<tbody><tr id="hof_faction_header">
				<td class="hof_faction_spacer"></td>
				<td class="hof_spacer_hz"></td>
				<td class="hof_faction_logo">
					<img src="do_img/global/hof/faction_logo_MMO.png" width="71" height="62" alt="Mars Mining Operations">
				</td>
				<td class="hof_spacer_hz"></td>
				<td class="hof_faction_logo">
					<img src="do_img/global/hof/faction_logo_EIC.png" width="71" height="62" alt="Earth Industries Corporation">
				</td>
				<td class="hof_spacer_hz"></td>
				<td class="hof_faction_logo">
					<img src="do_img/global/hof/faction_logo_VRU.png" width="71" height="62" alt="Venus Resources Unlimited">
				</td>
			</tr>

			<tr>
				<td class="rank_name">Members</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points"><?php echo $rnk->cr_allplayers(1);?></td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points"><?php echo $rnk->cr_allplayers(2);?></td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points"><?php echo $rnk->cr_allplayers(3);?></td>
			</tr>
			<tr>
				<td colspan="7" class="hof_spacer_vc"></td>
			</tr>
			<tr>
				<td class="rank_name">Ranking points</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">8,816,341,400</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">6,712,442,900</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">6,075,945,237</td>
			</tr>
			<tr>
				<td colspan="7" class="hof_spacer_vc"></td>
			</tr>
			<tr>
				<td class="rank_name">Experience points</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">8,327,813,905,047</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">6,311,809,136,893</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">5,732,034,490,898</td>
			</tr>
			<tr>
				<td colspan="7" class="hof_spacer_vc"></td>
			</tr>
			<tr>
				<td class="rank_name">Honor points</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">51,814,164,815</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">41,563,759,063</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">36,766,147,013</td>
			</tr>
			<tr>
				<td colspan="7" class="hof_spacer_vc"></td>
			</tr>
			<tr>
				<td class="rank_name">Players destroyed</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">10,087,301</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">8,509,866</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">7,907,937</td>
			</tr>
			<tr>
				<td colspan="7" class="hof_spacer_vc"></td>
			</tr>
			<tr>
				<td class="rank_name">Aliens destroyed</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">854,648,697</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">508,150,635</td>
				<td class="hof_spacer_hz"></td>
				<td class="rank_points">489,400,139</td>
			</tr>
		</tbody></table>
