                            ...
                            <div id="content">
                                ...
                                <div id="auction_container">
                                    ...
                                    <div id="auction_tab_wrapper">
                                        ...
                                        <div class=\"auction_tab_main\" data-custom=\"" . $cat['cID'] . "\" id=\"tab_" . $cat['cID'] . "\">DAILY</div>
...
?>
                                    ...
                                    <div class="mail_wrapper">
										<?php // get version from class ?>
                                        <div id="auction_mail_receiveLabel">In-Orbit-Feedback-Collector Version 0.0.0.1 pre-Alpha</div>
                                    </div>
                                </div>
                                <!-- Ende Content -->
                            </div>
